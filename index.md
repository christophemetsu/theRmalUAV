...
![](./reference/figures/Workflow_both.png)
...
with no argument. If your sensor is not listed, you may submit an issue
on GitHub to have it added. For details see the help page
