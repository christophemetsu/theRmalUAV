...
To obtain a table of available thermal sensor which you can use, run `T_uav_sensors()` with no argument. If your sensor is not listed, you may submit an issue on GitHub to have it added. For details see the help page (?T_uav_sensor) or contact the package author.
